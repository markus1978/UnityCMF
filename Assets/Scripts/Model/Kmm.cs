...
namespace UnityCMF.Kmm {
	...
	public class KmmPackageImpl : KmmPackage {
		...
		public void init() {
			...
			Tile_OnCurrentPath.Derived = false;
			...
			Tile_StatsChanges.Derived = false;
			...
			Game_CurrentPath.Derived = false;
			...
			Game_RegularPool.Derived = false;
			...
			Entity_ExtraPool.Derived = false;
			...
			QuestSlot_IsAvailable.Derived = false;
			...
			QuestSlot_IsCompleted.Derived = false;
			...
			ItemSlot_TurnsLeft.Derived = false;
			...
			Poolable_IsUnique.Derived = false;
			...
			StatsChanges_KathisLove.Derived = false;
			...
			StatsChanges_MarkusLove.Derived = false;
			...
			StatsChanges_Money.Derived = false;
			...
			StatsChanges_Experience.Derived = false;
			...
			StatsChanges_Level.Derived = false;
