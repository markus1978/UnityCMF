...
namespace UnityCMF.ECore {
	...
	public class EParameterImpl : CObjectImpl, EParameter {
		public EParameterImpl(UnityCMF.ECore.EClass eClass) {
			EObjectImpl(eClass);
		}
		...
		public EOperation EOperation {
			...
			set {
				...
				if (CNotificationRequired(UnityCMF.ecore.EcorePackage.cINSTANCE.EParameter_eOperation)) {
					CNotify(new Action(this, CAction.SET, UnityCMF.ecore.EcorePackage.cINSTANCE.EParameter_eOperation, oldValue, value, -1));
				}	
			}
		}
	}
