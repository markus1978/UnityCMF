...
class FeatureGenerator {
	...
	new(ModelGenerator2 modelGenerator) {
	...
	private def cName(EStructuralFeature eFeature) '''«eFeature.name.toFirstUpper»'''
	
	private def cName(EOperation eOperation) { eOperation.name.toFirstUpper }
